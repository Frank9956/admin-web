  ...
  const fetchOrderData = async () => {
    ...
    try {
      ...
      if (orderData.couponCode) {
        alert(`Looking for coupon with code = ${orderData.couponCode}`);
        ...
        if (!snap.empty) {
          ...
          if (totalBill >= coupon.minPurchase) {
            ...
            alert(`Coupon applied: ${JSON.stringify(couponCharge)}`);
          } else {
      ...
      alert(`Final charges: ${JSON.stringify(updatedCharges)}`);  // ✅ step 6
